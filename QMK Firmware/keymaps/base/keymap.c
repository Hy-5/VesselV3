...
//integrating CapsLock
/*static void caps_status(void) {
    
    // Set cursor position
    // oled_set_cursor(0, 1);
    if (host_keyboard_led_state().caps_lock) {
        // Caps Lock is on, show padlock image
        ...
        // Caps Lock is off, clear the image display area
        static const unsigned char PROGMEM caps_inactive[] = {
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        ...
        oled_write_raw_P((const char *)caps_inactive, sizeof(caps_inactive));
    }
}
*/
...
bool animation_on(void) {
    //static uint8_t last_frame = 255;
    //bool frame_changed = current_frame != last_frame;
    //if (frame_changed) {
    ...
    // 'frame_0_delay-0', 128x64px
        ...
        //last_frame = current_frame; // Update the last_frame to the current
    //}
    //return frame_changed; // Return true if we changed the frame, false otherwise
    return false;
}
...
bool oled_task_user(void) {
    ...
    */
    ...
    if (caps_lock_is_on) {
        ...
        // Your animation function, make sure it returns true if the frame has changed, false otherwise
    }
